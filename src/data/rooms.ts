...
export const DEPOSITO_POSITION = 12;
...
export const rooms: RoomDef[] = [
  // ----- Acesso -------------------------------------------------------
  {
    ...
    corridorPosition: 70, baseCleaningMinutes: 7, materialCost: 1, cleanable: true,
...

  {
    ...
    corridorPosition: 0, baseCleaningMinutes: 0, materialCost: 0, cleanable: false,
  ...
  },
  {
    ...
    corridorPosition: 8, baseCleaningMinutes: 3, materialCost: 2, cleanable: true,
